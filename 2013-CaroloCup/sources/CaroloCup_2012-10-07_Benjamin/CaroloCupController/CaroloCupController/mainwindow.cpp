...
void MainWindow::timerSlot() {
    if (mJoystick->isConnected())
    {
        ...
        // Scale servo value for end positions
        // This is specific for the gulliver cars. The
        // steering servo will not be able to move from
        // 0 -255, but about 41 - 185, center at 113.
        // Also, the joystick gives values that would
        // invert the steering direction, thus the
        // (255 - 113) for the center and the (255 - servo2)
        // when sending the value to the car.
        servo2 -= 128;
        servo2 = (servo2 * (185-41)) / 255.0;
        servo2 += (255 - 113);

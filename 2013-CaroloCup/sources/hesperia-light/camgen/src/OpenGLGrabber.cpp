...
namespace camgen {
    ...
    OpenGLGrabber::OpenGLGrabber(const KeyValueConfiguration &kvc, const ImageGrabberID &imageGrabberID, const ImageGrabberCalibration &imageGrabberCalibration, hesperia::data::environment::EgoState &egoState) :
        ...
        if (urlOfSCNXFile.isValid()) {
            ...
            m_sharedMemory = core::wrapper::SharedMemoryFactory::getInstance().createSharedMemory("CamGen", 640 * 480 * 3);
        ...
        m_extrinsicCalibrationRoot->setRotation(Point3(hesperia::data::Constants::PI/2, hesperia::data::Constants::PI/2, 0));
    }

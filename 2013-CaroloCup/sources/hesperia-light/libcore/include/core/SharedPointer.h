...
#ifndef HESPERIA_CORE_SHAREDPOINTER_H_
#define HESPERIA_CORE_SHAREDPOINTER_H_
            ...
            void release() {
                if ( (m_countablePointer != NULL) && (m_countablePointer->m_counter > 0) ) {
                    ...
                    if (m_countablePointer->m_counter == 0) {
                        HESPERIA_CORE_DELETE_POINTER(m_countablePointer->m_pointer);
                        HESPERIA_CORE_DELETE_POINTER(m_countablePointer);
                    }
                    // Reset own reference.
                    m_countablePointer = NULL;
                }
...
#endif /*HESPERIA_CORE_SHAREDPOINTER_H_*/

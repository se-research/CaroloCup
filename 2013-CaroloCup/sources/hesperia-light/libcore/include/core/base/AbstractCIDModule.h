...
#ifndef HESPERIA_CORE_BASE_ABSTRACTCIDMODULE_H_
#define HESPERIA_CORE_BASE_ABSTRACTCIDMODULE_H_
...
namespace core {
    namespace base {
         ...
         */
        class HESPERIA_API AbstractCIDModule : public InterruptibleModule, public Periodic {
            protected:
                /**
...
#endif /*HESPERIA_CORE_BASE_ABSTRACTCIDMODULE_H_*/

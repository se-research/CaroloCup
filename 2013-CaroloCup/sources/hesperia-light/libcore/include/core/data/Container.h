...
#ifndef HESPERIA_CORE_DATA_CONTAINER_H_
#define HESPERIA_CORE_DATA_CONTAINER_H_
...
namespace core {
    namespace data {
         ...
         */
        class HESPERIA_API Container : public core::base::Serializable {
            public:
                enum DATATYPE {
                    UNDEFINEDDATA                =  1,
                    CONFIGURATION                =  2,
...
#endif /*HESPERIA_CORE_DATA_CONTAINER_H_*/

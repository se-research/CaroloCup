...
namespace core {
    namespace data {
        ...
        ostream& Container::operator<<(ostream &out) const {
            ...
            s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL4('s', 'e', 'n', 't') >::RESULT,
                    m_sent);

            // Write received time stamp data.
            s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL5('r', 'e', 'c', 'v', 'd') >::RESULT,
                    m_received);
        ...
        istream& Container::operator>>(istream &in) {
            ...
            d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL4('s', 'e', 'n', 't') >::RESULT,
                   m_sent);

            // Read received time stamp data.
            d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('r', 'e', 'c', 'v', 'd') >::RESULT,
                   m_received);

...
#ifndef HESPERIA_BASE_CONFERENCECLIENTMODULE_H_
#define HESPERIA_BASE_CONFERENCECLIENTMODULE_H_
...
namespace hesperia {
    namespace base {
         ...
         * @endcode
         */
        class HESPERIA_API ConferenceClientModule : public ClientModule, public core::io::ContainerListener, public DataStoreManager {
            private:
                /**
...
#endif /*HESPERIA_BASE_CONFERENCECLIENTMODULE_H_*/

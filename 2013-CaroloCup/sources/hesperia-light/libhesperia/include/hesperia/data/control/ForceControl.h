...
#ifndef HESPERIA_DATA_CONTROL_FORCECONTROL_H_
#define HESPERIA_DATA_CONTROL_FORCECONTROL_H_
...
namespace hesperia {
    namespace data {
        namespace control {
             ...
             */
            class HESPERIA_API ForceControl : public core::data::SerializableData {
                public:
                    ForceControl();
                     ...
                     * @param u User data.
                     */
                    void setUserData(const uint32_t &u);
...
#endif /*HESPERIA_DATA_CONTROL_FORCECONTROL_H_*/

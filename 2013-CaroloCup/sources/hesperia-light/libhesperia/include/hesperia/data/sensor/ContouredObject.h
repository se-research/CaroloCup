...
namespace hesperia {
    namespace data {
        namespace sensor {
             ...
             */
            class HESPERIA_API ContouredObject : public environment::PointShapedObject {
                public:
                    ContouredObject();
                     ...
                     */
                    ContouredObject(const environment::Point3 &position, const environment::Point3 &rotation,
                                    const environment::Point3 &velocity, const environment::Point3 &acceleration);
                     ...
                     * @return Contour.
                     */
                    const vector<environment::Point3> getContour() const;
                     ...
                     */
                    void setContour(const vector<environment::Point3> &contour);
                ...
                private:
                    vector<environment::Point3> m_contour;
            };

    ...
    namespace decorator {
        ...
        class HESPERIA_API Renderer {
            ...
            public:
                 ...
                 */
                virtual void drawTriangleSet(const hesperia::decorator::models::TriangleSet &ts, const data::environment::Point3 &position, const data::environment::Point3 &rotation) = 0;
                 ...
                 * @param rotation Rotation.
                 */
                virtual void drawListOfTriangleSets(const vector<hesperia::decorator::models::TriangleSet> &listOfTriangleSets, const data::environment::Point3 &position, const data::environment::Point3 &rotation) = 0;
        };

...
namespace hesperia {
    namespace decorator {
        namespace twoD {
             ...
             * methods.
             */
            class HESPERIA_API Renderer2D : public hesperia::decorator::Renderer {
                public:
                    Renderer2D();
                ...
                public:
                    ...
                    virtual void drawImage(const core::wrapper::Image *image, const data::environment::Point3 &originPixelXY, const data::environment::Point3 &scalingPixelXY, const float &rotationZ) = 0;
                    ...
                    virtual void drawTriangleSet(const hesperia::decorator::models::TriangleSet &ts, const data::environment::Point3 &position, const data::environment::Point3 &rotation);

                    virtual void drawListOfTriangleSets(const vector<hesperia::decorator::models::TriangleSet> &listOfTriangleSets, const data::environment::Point3 &position, const data::environment::Point3 &rotation);
            };

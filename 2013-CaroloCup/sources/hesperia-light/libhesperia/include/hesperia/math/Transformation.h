...
namespace hesperia {
    namespace math {
         ...
         */
        class HESPERIA_API Transformation {
            private:
                /**
            ...
            public:
                 ...
                 */
                data::environment::Point3 transform(const data::environment::Point3 &coordinate, const data::environment::Position &position) const;
                 ...
                 * @return Transformed cartesian coordinate.
                 */
                data::environment::Point3 transformInversely(const data::environment::Point3 &coordinate, const data::environment::Position &position) const;
        };

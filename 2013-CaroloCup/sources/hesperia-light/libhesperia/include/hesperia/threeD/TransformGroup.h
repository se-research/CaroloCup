...
namespace hesperia {
    namespace threeD {
         ...
         */
        class HESPERIA_API TransformGroup : public Node {
            private:
                /**
            ...
            public:
                 ...
                 * @param t Translation.
                 */
                void setTranslation(const data::environment::Point3 &t);
                 ...
                 * @return Translation.
                 */
                data::environment::Point3 getTranslation() const;
                 ...
                 * @param r Rotation.
                 */
                void setRotation(const data::environment::Point3 &r);
                 ...
                 * @return Rotation.
                 */
                data::environment::Point3 getRotation() const;
                 ...
                 * @param s Scaling.
                 */
                void setScaling(const data::environment::Point3 &s);
                 ...
                 * @return Scaling.
                 */
                data::environment::Point3 getScaling() const;
            ...
            private:
                data::environment::Point3 m_translation;
                data::environment::Point3 m_rotation;
                data::environment::Point3 m_scaling;

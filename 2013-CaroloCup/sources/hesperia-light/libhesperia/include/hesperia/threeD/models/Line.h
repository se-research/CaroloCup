            ...
            class Line : public Node {
                public:
                    ...
                    * @param nodeDesciptor Description for this node.
                     ...
                     */
                    Line(const NodeDescriptor &nodeDescriptor, const data::environment::Point3 &positionA, const data::environment::Point3 &positionB, const data::environment::Point3 &color, const float &width);
                ...
                private:
                    data::environment::Point3 m_positionA;
                    data::environment::Point3 m_positionB;

        ...
        namespace models {
            ...
            class Point : public Node {
                public:
                     ...
                     */
                    Point(const NodeDescriptor &nodeDescriptor, const data::environment::Point3 &position, const data::environment::Point3 &color, const float &width);
                ...
                private:
                    data::environment::Point3 m_position;

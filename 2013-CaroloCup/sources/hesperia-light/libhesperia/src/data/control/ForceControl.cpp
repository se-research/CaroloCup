...
namespace hesperia {
    namespace data {
        namespace control {
            ...
            uint32_t ForceControl::getUserData() const {
                return m_userData;
            }

            void ForceControl::setUserData(const uint32_t &u) {
                m_userData = u;
            }

            const string ForceControl::toString() const {
                stringstream sstr;
                sstr << "Acceleration force: " << getAccelerationForce() << ", Brake force: " << getBrakeForce() << ", Steering force: " << getSteeringForce() << ", brake lights: " << getBrakeLights() << ", flashingLightsLeft: " << getLeftFlashingLights() << ", flashingLightsRight: " << getRightFlashingLights() << ", user data: " << getUserData();
                return sstr.str();
            }
            ...
            ostream& ForceControl::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL5('b', 'r', 'a', 'k', 'e') >::RESULT,
                        m_brakeForce);
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL5('u', 'd', 'a', 't', 'a') >::RESULT,
                        m_userData);
            ...
            istream& ForceControl::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('b', 'r', 'a', 'k', 'e') >::RESULT,
                       m_brakeForce);
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('u', 'd', 'a', 't', 'a') >::RESULT,
                        m_userData);

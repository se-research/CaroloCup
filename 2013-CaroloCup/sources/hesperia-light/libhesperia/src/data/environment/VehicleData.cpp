    ...
    namespace data {
        namespace environment {
            ...
            ostream& VehicleData::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL4('v', 'l', 'o', 'g') >::RESULT,
                        m_v_log);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL4('v', 'b', 'a', 't') >::RESULT,
                        m_v_batt);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL4('t', 'e', 'm', 'p') >::RESULT,
                        m_temp);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL3('s', 'i', 'm') >::RESULT,
                        m_isSimulation);
            ...
            istream& VehicleData::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL4('v', 'l', 'o', 'g') >::RESULT,
                       m_v_log);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL4('v', 'b', 'a', 't') >::RESULT,
                       m_v_batt);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL4('t', 'e', 'm', 'p') >::RESULT,
                       m_temp);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL3('s', 'i', 'm') >::RESULT,
                       m_isSimulation);

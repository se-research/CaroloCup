    ...
    namespace data {
        namespace scenario {
            ...
            ostream& Ground::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL6('a', 'e', 'r', 'i', 'a', 'l') >::RESULT,
                        m_aerialImage);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL6('h', 'e', 'i', 'g', 'h', 't') >::RESULT,
                        m_heightImage);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL8('s', 'u', 'r', 'r', 'o', 'u', 'n', 'd') >::RESULT,
                        m_surroundings);
            ...
            istream& Ground::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL6('a', 'e', 'r', 'i', 'a', 'l') >::RESULT,
                       m_aerialImage);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL6('h', 'e', 'i', 'g', 'h', 't') >::RESULT,
                       m_heightImage);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL8('s', 'u', 'r', 'r', 'o', 'u', 'n', 'd') >::RESULT,
                       m_surroundings);

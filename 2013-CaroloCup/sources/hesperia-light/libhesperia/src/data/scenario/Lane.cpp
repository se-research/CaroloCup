...
namespace hesperia {
    namespace data {
        namespace scenario {
            ...
            Lane::~Lane() {
                HESPERIA_CORE_DELETE_POINTER(m_laneModel);
            }
            ...
            ostream& Lane::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL7('h', 'a', 's', 'l', 'a', 'm', 'd') >::RESULT,
                        hasLaneModel);

                if (hasLaneModel) {
                    s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL7('l', 'a', 'n', 'e', 'm', 'd', 'l') >::RESULT,
            ...
            istream& Lane::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL7('h', 'a', 's', 'l', 'a', 'm', 'd') >::RESULT,
                       hasLaneModel);

                if (hasLaneModel) {
                    uint32_t type = 0;
                    d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL7('l', 'a', 'n', 'e', 'm', 'd', 'l') >::RESULT,
                           type);

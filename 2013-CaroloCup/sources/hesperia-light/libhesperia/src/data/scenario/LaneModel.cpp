        ...
        namespace scenario {
            ...
            void LaneModel::cleanUp() {
                ...
                while (it != m_listOfTrafficControls.end()) {
                    TrafficControl *tc = (*it++);
                    HESPERIA_CORE_DELETE_POINTER(tc);
                }
            ...
            istream& LaneModel::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('l', 'a', 't', 't', 'r') >::RESULT,
                       m_laneAttribute);

                uint32_t type = 0;
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL4('t', 'y', 'p', 'e') >::RESULT,
                       type);
                ...
                uint32_t numberOfTrafficControls = 0;
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL8('n', 'u', 'm', 't', 'r', 'a', 'f', 'c') >::RESULT,
                       numberOfTrafficControls);

                if (numberOfTrafficControls > 0) {
                    string str;
                    // Read traffic controls into stringstream.
                    d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL6('t', 'r', 'a', 'f', 'c', 's') >::RESULT,
                           str);
                ...
                if (numberOfConnectors > 0) {
                    ...
                    d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL4('c', 'o', 'n', 'n') >::RESULT,
                           str);

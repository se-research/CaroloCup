    ...
    namespace data {
        namespace scenario {
            ...
            ostream& Zone::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL8('p', 'e', 'r', 'i', 'm', 't', 'e', 'r') >::RESULT,
                        getPerimeter());
                ...
                if (numberOfConnectors > 0) {
                    s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL5('c', 'o', 'n', 'n', 's') >::RESULT,
                            sstr.str());
                }

                uint32_t numberOfSpots = static_cast<uint32_t>(m_listOfSpots.size());
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL8('n', 'u', 'm', 's', 'p', 'o', 't', 's') >::RESULT,
                        numberOfSpots);
                ...
                // Write spots.
                if (numberOfSpots > 0) {
                    s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL5('s', 'p', 'o', 't', 's') >::RESULT,
                            sstr.str());
                }
            ...
            istream& Zone::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL8('p', 'e', 'r', 'i', 'm', 't', 'e', 'r') >::RESULT,
                       m_perimeter);

                uint32_t numberOfConnectors = 0;
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL8('n', 'u', 'm', 'c', 'o', 'n', 'n', 's') >::RESULT,
                       numberOfConnectors);

                if (numberOfConnectors > 0) {
                    string str;
                    // Read connectors into stringstream.
                    d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('c', 'o', 'n', 'n', 's') >::RESULT,
                           str);
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL8('n', 'u', 'm', 's', 'p', 'o', 't', 's') >::RESULT,
                       numberOfSpots);

                if (numberOfSpots > 0) {
                    string str;
                    // Read spots into stringstream.
                    d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('s', 'p', 'o', 't', 's') >::RESULT,
                           str);

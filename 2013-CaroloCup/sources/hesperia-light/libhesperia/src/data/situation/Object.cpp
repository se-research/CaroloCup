...
namespace hesperia {
    namespace data {
        namespace situation {
            ...
            void Object::cleanUp() {
                HESPERIA_CORE_DELETE_POINTER(m_shape);
                HESPERIA_CORE_DELETE_POINTER(m_behavior);
            }
            ...
            istream& Object::operator>>(istream &in) {
                ...
                bool hasShape = false;
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL8('h', 'a', 's', 's', 'h', 'a', 'p', 'e') >::RESULT,
                       hasShape);

                if (hasShape) {
                    string str;
                    // Read shapes into stringstream.
                    d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('s', 'h', 'a', 'p', 'e') >::RESULT,
                           str);
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL8('h', 'a', 's', 'b', 'e', 'h', 'a', 'v') >::RESULT,
                       hasBehavior);

                if (hasBehavior) {
                    string str;
                    // Read shapes into stringstream.
                    d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('b', 'e', 'h', 'a', 'v') >::RESULT,
                           str);

    ...
    namespace data {
        namespace situation {
            ...
            ostream& Rectangle::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL6('l', 'e', 'n', 'g', 't', 'h') >::RESULT,
                        m_length);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL5('w', 'i', 'd', 't', 'h') >::RESULT,
                        m_width);
            ...
            istream& Rectangle::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL6('l', 'e', 'n', 'g', 't', 'h') >::RESULT,
                       m_length);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('w', 'i', 'd', 't', 'h') >::RESULT,
                       m_width);

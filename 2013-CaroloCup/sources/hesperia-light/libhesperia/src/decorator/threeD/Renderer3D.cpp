...
namespace hesperia {
    namespace decorator {
        namespace threeD {
            ...
            void Renderer3D::drawListOfTriangleSets(const vector<hesperia::decorator::models::TriangleSet> &listOfTriangleSets, const data::environment::Point3 &position, const data::environment::Point3 &rotation) {
                glTranslatef(static_cast<float>(position.getX()), static_cast<float>(position.getY()), static_cast<float>(position.getZ()));
                ...
                glPushMatrix();
                {
                    ...
                    Point3 rotateAroundXAxis(data::Constants::PI/2.0, 0, 0);

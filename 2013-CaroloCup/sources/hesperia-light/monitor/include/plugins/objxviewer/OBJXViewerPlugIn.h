...
#ifndef MONITOR_PLUGINS_OBJXVIEWER_OBJXVIEWERPLUGIN_H_
#define MONITOR_PLUGINS_OBJXVIEWER_OBJXVIEWERPLUGIN_H_
...
#endif /*MONITOR_PLUGINS_OBJXVIEWER_OBJXVIEWERPLUGIN_H_*/

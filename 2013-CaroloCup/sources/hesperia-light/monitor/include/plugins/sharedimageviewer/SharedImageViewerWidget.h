...
#ifndef MONITOR_PLUGINS_SHAREDIMAGEVIEWER_SHAREDIMAGEVIEWERWIDGET_H_
#define MONITOR_PLUGINS_SHAREDIMAGEVIEWER_SHAREDIMAGEVIEWERWIDGET_H_
    ...
    namespace sharedimageviewer {
        ...
        class SharedImageViewerWidget : public QWidget, public core::io::ContainerListener {
            ...
            private:
                ...
                hesperia::data::image::SharedImage m_sharedImage;
                ...
                map<string, hesperia::data::image::SharedImage> m_mapOfAvailableSharedImages;
...
#endif /*MONITOR_PLUGINS_SHAREDIMAGEVIEWER_SHAREDIMAGEVIEWERWIDGET_H_*/

...
namespace plugins {
    ...
    AbstractGLWidget::AbstractGLWidget(const PlugIn &plugIn, QWidget *prnt) :
            ...
            m_pitchZ(0),
            m_scale(1),
            m_phi(static_cast<float>(-hesperia::data::Constants::PI)),
            m_theta(static_cast<float>(-hesperia::data::Constants::PI / 4)),
            m_epsilon(0),
        ...
        m_phi = -hesperia::data::Constants::PI + 0.1;
    ...
    void AbstractGLWidget::paintGL() {
        ...
        m_theta = (m_theta < -hesperia::data::Constants::PI) ? -hesperia::data::Constants::PI : m_theta;

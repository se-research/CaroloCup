...
void drawline(IplImage* color_dst, int maxXR, int maxXL, int maxYR, int maxYL,
...
double calcSumDegree(int count, CvPoint* middle) {
...
void printText(double ang, IplImage* color_dst) {
...
double calcSumDistanceFromCenter_for_Parking(int count,
...
int main(int argc, char** argv) {
	...
	for (;;) {
		...
		if (countBoth > 1) {
			...
			//Average distance
			sumDistance = calcSumDistanceFromCenter_for_Parking(countBoth,
					parkingDistance);
			AverageDistanceFromCenter = sumDistance / countBoth;
			...
			//Average distance from the center to right line
			sumDistance = calcSumDistanceFromCenter_for_Parking(countOne,
					parkingDistance);
			AverageDistanceFromCenter = sumDistance / countOne;

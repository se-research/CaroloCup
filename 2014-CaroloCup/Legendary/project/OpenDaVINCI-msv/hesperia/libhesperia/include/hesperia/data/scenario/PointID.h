...
#ifndef HESPERIA_CORE_DATA_SCENARIO_POINTID_H_
#define HESPERIA_CORE_DATA_SCENARIO_POINTID_H_
...
namespace hesperia {
    namespace data {
        namespace scenario {
             ...
             */
            class OPENDAVINCI_API PointID : public core::data::SerializableData, public ScenarioNode {
                public:
                    PointID();
...
#endif /*HESPERIA_CORE_DATA_SCENARIO_POINTID_H_*/

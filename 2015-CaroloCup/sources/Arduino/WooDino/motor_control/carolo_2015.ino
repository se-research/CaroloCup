...
void controlSteering() {
  ...
  // STEER_FACTOR is the relation between the max angle sent from driver and the
  // max angle of the servo on the car.
  angle = 90 + (angle * STEER_FACTOR) * multiplier;
  //Serial.println(angle);

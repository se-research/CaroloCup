...
void LineDetector::findLines()
{
    ...
    // -- testing of new_estimateLines & new_calculateGoalLine (these 
    //          functions has been replaced but the code may be of use):
...
// Handles estimations and setting up goal lines

    ...
    namespace wrapper {
        namespace POSIX {
            ...
            bool POSIXSerialPort::setDataBits(const SerialPortSettings::SerialPortDataBits &dataBits) {
                ...
                switch (dataBits) {
                    case SerialPortSettings::DATA_5:
                        options.c_cflag |= CS5;
                    break;

                    case SerialPortSettings::DATA_6:
                        options.c_cflag |= CS6;
                    break;

                    case SerialPortSettings::DATA_7:
                        options.c_cflag |= CS7;
                    break;
            ...
            bool POSIXSerialPort::setStopBits(const SerialPortSettings::SerialPortStopBits &stopBits) {
                ...
                switch (stopBits) {
                    case SerialPortSettings::STOP_2:
            ...
            bool POSIXSerialPort::setParity(const SerialPortSettings::SerialPortParity &parity) {
                ...
                switch (parity) {
                    case SerialPortSettings::PARITY_EVEN:
                        options.c_cflag |= PARENB;
                        options.c_cflag &= ~PARODD;
                    break;

                    case SerialPortSettings::PARITY_ODD:
                        options.c_cflag |= PARENB;
                        options.c_cflag |= PARODD;
                    break;

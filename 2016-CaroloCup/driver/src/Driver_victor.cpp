...
// 				<< endl;
		...
		//Sensors
		IRdis_SL = sbd.getValueForKey_MapOfDistances(3); // Side Left IR // *on legendary is the Front-Side-Right
		IRdis_RL = sbd.getValueForKey_MapOfDistances(0); // Rear Left IR
		IRdis_RR = sbd.getValueForKey_MapOfDistances(1); // Rear Right IR
		IRdis_SR = sbd.getValueForKey_MapOfDistances(2); // Side Right IR
		USFront = sbd.getValueForKey_MapOfDistances(4); // Front UltraSonic
		USRear = sbd.getValueForKey_MapOfDistances(5); // Rear UltraSonic 
		
		//WheelEncoder
		Distance = sbd.getValueForKey_MapOfDistances(6); // WheeelEncoder Data (mm)

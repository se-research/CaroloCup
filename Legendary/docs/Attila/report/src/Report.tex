...
\firstabstract{
  ...
  competition are lane following, crash avoidance, overtaking, intersection
  handling and parking. This report provides solutions for one of these
  functionalities, both describing its theoretical background and presenting a
  working implementation. The functionality covered by this report is lane
  following.
}

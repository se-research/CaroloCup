    ...
    ModuleState::MODULE_EXITCODE ProxySTM32F4::body() {
        ...
        while (getModuleState() == ModuleState::RUNNING) {
            ...
            switch (protocolCounter) {
                case 1:
                    protocol.request(STM32F4Protocol::AllInfrareds, speed, steering);
                break;
                case 2:
                    protocol.request(STM32F4Protocol::AllUltrasonics, speed, steering);
                break;
                case 3:
                    protocol.request(STM32F4Protocol::Orientation, speed, steering);
                break;
                case 4:
                    protocol.request(STM32F4Protocol::CurrentPosition, speed, steering);
                break;
                case 5:
                    protocol.request(STM32F4Protocol::TraveledPath, speed, steering);
                    protocolCounter = 0;
                break;
            }

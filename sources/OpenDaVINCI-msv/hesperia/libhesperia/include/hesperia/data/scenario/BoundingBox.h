...
#ifndef HESPERIA_CORE_DATA_SCENARIO_BOUNDINGBOX_H_
#define HESPERIA_CORE_DATA_SCENARIO_BOUNDINGBOX_H_
...
namespace hesperia {
    namespace data {
        namespace scenario {
             ...
             */
            class OPENDAVINCI_API BoundingBox : public core::data::SerializableData, public ScenarioNode {
                public:
                    BoundingBox();
...
#endif /*HESPERIA_CORE_DATA_SCENARIO_BOUNDINGBOX_H_*/

...
#ifndef HESPERIA_CORE_BASE_CONDITION_H_
#define HESPERIA_CORE_BASE_CONDITION_H_
...
namespace core {
    namespace base {
         ...
         */
        class HESPERIA_API Condition : public Mutex {
            private:
                friend class Lock;
...
#endif /*HESPERIA_CORE_BASE_CONDITION_H_*/

...
#ifndef HESPERIA_CORE_BASE_HASH_H_
#define HESPERIA_CORE_BASE_HASH_H_

#define HESPERIA_CORE_STRINGLITERAL1(a)                      CharList<a, NullType>
#define HESPERIA_CORE_STRINGLITERAL2(a, b)                   CharList<a, CharList<b, NullType> >
#define HESPERIA_CORE_STRINGLITERAL3(a, b, c)                CharList<a, CharList<b, CharList<c, NullType> > >
#define HESPERIA_CORE_STRINGLITERAL4(a, b, c, d)             CharList<a, CharList<b, CharList<c, CharList<d, NullType> > > >
#define HESPERIA_CORE_STRINGLITERAL5(a, b, c, d, e)          CharList<a, CharList<b, CharList<c, CharList<d, CharList<e, NullType> > > > >
#define HESPERIA_CORE_STRINGLITERAL6(a, b, c, d, e, f)       CharList<a, CharList<b, CharList<c, CharList<d, CharList<e, CharList<f, NullType> > > > > >
#define HESPERIA_CORE_STRINGLITERAL7(a, b, c, d, e, f, g)    CharList<a, CharList<b, CharList<c, CharList<d, CharList<e, CharList<f, CharList<g, NullType> > > > > > >
#define HESPERIA_CORE_STRINGLITERAL8(a, b, c, d, e, f, g, h) CharList<a, CharList<b, CharList<c, CharList<d, CharList<e, CharList<f, CharList<g, CharList<h, NullType> > > > > > > >
...
#endif /*HESPERIA_CORE_BASE_HASH_H_*/

...
#ifndef HESPERIA_CORE_DATA_TIMESTAMP_H_
#define HESPERIA_CORE_DATA_TIMESTAMP_H_
...
namespace core {
    namespace data {
         ...
         */
        class HESPERIA_API TimeStamp : public SerializableData {
            private:
...
#endif /*HESPERIA_CORE_DATA_TIMESTAMP_H_*/

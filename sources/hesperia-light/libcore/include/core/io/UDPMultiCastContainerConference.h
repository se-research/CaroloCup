...
#ifndef HESPERIA_CORE_IO_UDPMULTICASTCONTAINERCONFERENCE_H_
#define HESPERIA_CORE_IO_UDPMULTICASTCONTAINERCONFERENCE_H_
...
namespace core {
    namespace io {
         ...
         */
        class HESPERIA_API UDPMultiCastContainerConference : public ContainerConference, public wrapper::StringListener {
            private:
...
#endif /*HESPERIA_CORE_IO_UDPMULTICASTCONTAINERCONFERENCE_H_*/

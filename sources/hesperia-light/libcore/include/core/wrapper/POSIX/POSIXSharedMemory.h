...
#ifndef HESPERIA_CORE_WRAPPER_POSIX_POSIXSHAREDMEMORY_H_
#define HESPERIA_CORE_WRAPPER_POSIX_POSIXSHAREDMEMORY_H_
...
namespace core {
    namespace wrapper {
        namespace POSIX {
            ...
            class POSIXSharedMemoryFactory;
            ...
            class POSIXSharedMemory : public SharedMemory {
                private:
                    friend class POSIXSharedMemoryFactory;
...
#endif /*HESPERIA_CORE_WRAPPER_POSIX_POSIXSHAREDMEMORY_H_*/

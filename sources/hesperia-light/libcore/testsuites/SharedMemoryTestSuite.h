...
class SharedMemoryTest : public CxxTest::TestSuite {
    public:
        void testSharedMemory() {
            ...
            core::SharedPointer<core::wrapper::SharedMemory> memServer = core::wrapper::SharedMemoryFactory::getInstance().createSharedMemory("SharedMemoryTest", 10);
            ...
            memClient = core::wrapper::SharedMemoryFactory::getInstance().attachToSharedMemory("SharedMemoryTest");
            TS_ASSERT(memClient->isValid());

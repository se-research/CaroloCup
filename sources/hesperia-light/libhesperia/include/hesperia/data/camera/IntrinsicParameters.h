...
namespace hesperia {
    namespace data {
        namespace camera {
             ...
             */
            class HESPERIA_API IntrinsicParameters : public core::data::SerializableData {
                public:
                    IntrinsicParameters();
                     ...
                     */
                    const environment::Point3 getPrinciplePoint() const;
                     ...
                     */
                    void setPrinciplePoint(const environment::Point3 &principlePoint);
                     ...
                     * @return Focal length.
                     */
                    const environment::Point3 getFocalLength() const;
                     ...
                     */
                    void setFocalLength(const environment::Point3 &focalLength);
                ...
                private:
                    environment::Point3 m_principlePoint;
                    environment::Point3 m_focalLength;

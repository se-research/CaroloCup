...
#ifndef HESPERIA_DATA_ENVIRONMENT_MATRIX3X3_H_
#define HESPERIA_DATA_ENVIRONMENT_MATRIX3X3_H_
...
namespace hesperia {
    namespace data {
        namespace environment {
             ...
             */
            class HESPERIA_API Matrix3x3 : public core::data::SerializableData {
                private:
...
#endif /*HESPERIA_DATA_ENVIRONMENT_MATRIX3X3_H_*/

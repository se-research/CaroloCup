...
namespace hesperia {
    namespace decorator {
        namespace threeD {
             ...
             */
            class HESPERIA_API Renderer3D : public hesperia::decorator::Renderer {
                public:
                    Renderer3D();
                ...
                public:
                    ...
                    virtual void drawImage(const core::wrapper::Image *image, const data::environment::Point3 &originPixelXY, const data::environment::Point3 &scalingPixelXY, const float &rotationZ);

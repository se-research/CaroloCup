...
namespace hesperia {
    namespace threeD {
        namespace models {
             ...
             */
            class HESPERIA_API AerialImageRenderer : public Node {
                public:
                    /**
                     * Constructor.
                     *
             ...
             */
            class HESPERIA_API AerialImage : public Node {
                public:
                    /**
                     * Constructor.
                     *
                    * @param nodeDesciptor Description for this node.
                    ...
                    AerialImage(const NodeDescriptor &nodeDescriptor,
                                ...
                                const data::environment::Point3 &originPixelXY,
                                const data::environment::Point3 &scalingPixelXY,
                ...
                private:
                    ...
                    data::environment::Point3 m_originPixelXY;
                    data::environment::Point3 m_scalingPixelXY;
                    float m_rotationZ;

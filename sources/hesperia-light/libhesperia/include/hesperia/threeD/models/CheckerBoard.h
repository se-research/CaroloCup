...
namespace hesperia {
    namespace threeD {
        namespace models {
             ...
             */
            class HESPERIA_API CheckerBoard : public Node {
                public:
                    /**
                     ...
                     */
                    CheckerBoard(const NodeDescriptor &nodeDescriptor, const data::environment::Point3 &positionA, const data::environment::Point3 &positionB, const float &height);

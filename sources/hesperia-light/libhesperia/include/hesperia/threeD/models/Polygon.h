...
namespace hesperia {
    namespace threeD {
        namespace models {
             ...
             */
            class HESPERIA_API Polygon : public Node {
                public:
                    /**
                     * Constructor.
                     *
                    * @param nodeDesciptor Description for this node.
                     ...
                     */
                    Polygon(const NodeDescriptor &nodeDescriptor, const vector<data::environment::Point3> &listOfGroundVertices, const data::environment::Point3 &color, const float &height);
                ...
                private:
                    vector<data::environment::Point3> m_listOfGroundVertices;
                    data::environment::Point3 m_color;
                    float m_height;
            };

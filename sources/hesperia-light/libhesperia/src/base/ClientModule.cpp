...
#include "hesperia/base/ClientModule.h"
...
namespace hesperia {
    namespace base {
        ...
        void ClientModule::wait() {
            ...
            const long NOMINAL_DURATION_OF_ONE_SLICE = (1.0f/FREQ) * ONE_SECOND_IN_MICROSECONDS;
            ...
            if (FREQ < 1) {
                ...
                const int32_t CYCLES_PER_SECOND = fabs(round(FREQ));
        ...
        ModuleState::MODULE_EXITCODE ClientModule::runModule()
        {
            ...
            // Supercomponent finden. Wenn der dmcp::discoverer::Client
            // erfolgreich eine DMCP_DISCOVER Nachricht verschickt und
            // eine Antwort erhält, ist alles in Ordnung und man kann sich
            // durch die Informationen der ServerInformation mit der
            // supercomponent verbinden.
            ...
            ModuleDescriptor md(getName(), getIdentifier(), getVersion());

    ...
    namespace data {
        namespace camera {
            ...
            ostream& ExtrinsicParameters::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL5('t', 'r', 'a', 'n', 's') >::RESULT,
                        m_translation);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL3('r', 'o', 't') >::RESULT,
                        m_rotation);
            ...
            istream& ExtrinsicParameters::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('t', 'r', 'a', 'n', 's') >::RESULT,
                       m_translation);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL3('r', 'o', 't') >::RESULT,
                       m_rotation);

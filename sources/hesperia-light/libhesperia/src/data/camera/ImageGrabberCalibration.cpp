    ...
    namespace data {
        namespace camera {
            ...
            ostream& ImageGrabberCalibration::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL3('e', 'x', 't') >::RESULT,
                        m_extrinsicParameters);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL3('i', 'n', 't') >::RESULT,
                        m_intrinsicParameters);
            ...
            istream& ImageGrabberCalibration::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL3('e', 'x', 't') >::RESULT,
                       m_extrinsicParameters);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL3('i', 'n', 't') >::RESULT,
                       m_intrinsicParameters);

    ...
    namespace data {
        namespace camera {
            ...
            ostream& IntrinsicParameters::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL8('p', 'r', 'i', 'n', 'c', 'i', 'p', 'l') >::RESULT,
                        m_principlePoint);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL8('f', 'o', 'c', 'a', 'l', 'l', 'e', 'n') >::RESULT,
                        m_focalLength);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL7('f', 'o', 'c', 'd', 'i', 's', 't') >::RESULT,
                        m_focalDistance);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL5('a', 'l', 'p', 'h', 'a') >::RESULT,
                        m_alpha);
            ...
            istream& IntrinsicParameters::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL8('p', 'r', 'i', 'n', 'c', 'i', 'p', 'l') >::RESULT,
                       m_principlePoint);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL8('f', 'o', 'c', 'a', 'l', 'l', 'e', 'n') >::RESULT,
                       m_focalLength);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL7('f', 'o', 'c', 'd', 'i', 's', 't') >::RESULT,
                       m_focalDistance);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('a', 'l', 'p', 'h', 'a') >::RESULT,
                       m_alpha);

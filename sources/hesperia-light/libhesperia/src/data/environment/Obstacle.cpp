    ...
    namespace data {
        namespace environment {
            ...
            ostream& Obstacle::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL5('s', 't', 'a', 't', 'e') >::RESULT,
                        static_cast<uint32_t>(m_state));

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL5('c', 'l', 'a', 's', 's') >::RESULT,
                        static_cast<uint32_t>(m_classification));

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL7('p', 'o', 'l', 'y', 'g', 'o', 'n') >::RESULT,
                        m_polygon);
            ...
            istream& Obstacle::operator>>(istream &in) {
                ...
                uint32_t v = 0;
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('s', 't', 'a', 't', 'e') >::RESULT,
                       v);
                m_state = static_cast<Obstacle::STATE>(v);

                v = 0;
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('c', 'l', 'a', 's', 's') >::RESULT,
                       v);
                m_classification = static_cast<Obstacle::CLASSIFICATION>(v);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL7('p', 'o', 'l', 'y', 'g', 'o', 'n') >::RESULT,
                       m_polygon);

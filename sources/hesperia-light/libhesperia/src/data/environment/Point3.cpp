...
//                const double oneSubcosAngle = 1.0 - cosAngle;
//                const double sinAngle = sin(angle);
//                const double x = direction.getX();
//                const double y = direction.getY();
//                const double z = direction.getZ();
//
//                Point3 row1( oneSubcosAngle * x * x + cosAngle ,
//                             oneSubcosAngle * x * y - ( z * sinAngle ),
//                             oneSubcosAngle * x * z + ( y * sinAngle ) );
//
//                Point3 row2( oneSubcosAngle * y * x + ( z * sinAngle),
//                             oneSubcosAngle * y * y + cosAngle,
//                             oneSubcosAngle * y * z - ( x * sinAngle ) );
//
//                Point3 row3( oneSubcosAngle * z * x - ( y * sinAngle),
//                             oneSubcosAngle * z * y + ( x * sinAngle ),
//                             oneSubcosAngle * z * z + cosAngle);
//
//                double rotX = operator*(row1);
//                double rotY = operator*(row2);
//                double rotZ = operator*(row3);
//
//                setX(rotX);
//                setY(rotY);
//                setZ(rotZ);
            ...
            istream& Point3::operator>>(istream &in) {
                ...
                string data;
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL4('d', 'a', 't', 'a') >::RESULT,
                       data);

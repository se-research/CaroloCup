...
//                while ( (d < dOld) && (d > epsilon) && (iterations < 50000)) {
            ...
            ostream& WGS84Coordinate::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL3('l', 'a', 't') >::RESULT,
                        m_lat);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL6('l', 'a', 't', 'd', 'i', 'r') >::RESULT,
                        static_cast<uint32_t>(m_LATITUDE));

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL3('l', 'o', 'n') >::RESULT,
                        m_lon);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL6('l', 'o', 'n', 'd', 'i', 'r') >::RESULT,
            ...
            istream& WGS84Coordinate::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL3('l', 'a', 't') >::RESULT,
                       m_lat);

                uint32_t l = 0;
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL6('l', 'a', 't', 'd', 'i', 'r') >::RESULT,
                       l);
                m_LATITUDE = static_cast<WGS84Coordinate::LATITUDE>(l);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL3('l', 'o', 'n') >::RESULT,
                       m_lon);

                l = 0;
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL6('l', 'o', 'n', 'd', 'i', 'r') >::RESULT,
                       l);

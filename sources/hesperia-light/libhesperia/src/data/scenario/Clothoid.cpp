    ...
    namespace data {
        namespace scenario {
            ...
            ostream& Clothoid::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL2('d', 'k') >::RESULT,
                        getDK());

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL1('k') >::RESULT,
                        getK());
            ...
            istream& Clothoid::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL2('d', 'k') >::RESULT,
                       m_dk);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL1('k') >::RESULT,
                       m_k);

    ...
    namespace data {
        namespace scenario {
            ...
            istream& HeightImage::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL7('g', 'r', 'o', 'u', 'n', 'd', 'h') >::RESULT,
                       m_groundHeight);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL4('m', 'i', 'n', 'h') >::RESULT,
                       m_minimumHeight);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL4('m', 'a', 'x', 'h') >::RESULT,
                       m_maximumHeight);

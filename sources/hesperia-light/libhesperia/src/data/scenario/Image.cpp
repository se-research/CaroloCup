    ...
    namespace data {
        namespace scenario {
            ...
            ostream& Image::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL8('f', 'i', 'l', 'e', 'n', 'a', 'm', 'e') >::RESULT,
                        m_fileName);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL1('x') >::RESULT,
                        m_originX);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL1('y') >::RESULT,
                        m_originY);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL4('m', 'p', 'p', 'x') >::RESULT,
                        m_meterPerPixelX);

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL4('m', 'p', 'p', 'y') >::RESULT,
                        m_meterPerPixelY);
            ...
            istream& Image::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL8('f', 'i', 'l', 'e', 'n', 'a', 'm', 'e') >::RESULT,
                       m_fileName);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL1('x') >::RESULT,
                       m_originX);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL1('y') >::RESULT,
                       m_originY);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL4('m', 'p', 'p', 'x') >::RESULT,
                       m_meterPerPixelX);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL4('m', 'p', 'p', 'y') >::RESULT,
                       m_meterPerPixelY);

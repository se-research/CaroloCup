    ...
    namespace data {
        namespace scenario {
            ...
            ostream& Perimeter::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL8('n', 'u', 'm', 'i', 'd', 'v', 'e', 'x') >::RESULT,
                        numberOfIDVertices);
                ...
                if (numberOfIDVertices > 0) {
                    s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL5('i', 'd', 'v', 'e', 'x') >::RESULT,
                            sstr.str());
                }
            ...
            istream& Perimeter::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL8('n', 'u', 'm', 'i', 'd', 'v', 'e', 'x') >::RESULT,
                       numberOfIDVertices);

                if (numberOfIDVertices > 0) {
                    string str;
                    // Read lanes into stringstream.
                    d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('i', 'd', 'v', 'e', 'x') >::RESULT,
                           str);

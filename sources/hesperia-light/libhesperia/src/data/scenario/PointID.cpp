    ...
    namespace data {
        namespace scenario {
            ...
            ostream& PointID::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL5('l', 'a', 'y', 'e', 'r') >::RESULT,
                        getLayerID());

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL4('r', 'o', 'a', 'd') >::RESULT,
                        getRoadID());

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL4('l', 'a', 'n', 'e') >::RESULT,
                        getLaneID());

                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL5('p', 'o', 'i', 'n', 't') >::RESULT,
                        getPointID());
            ...
            istream& PointID::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('l', 'a', 'y', 'e', 'r') >::RESULT,
                       m_layerID);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL4('r', 'o', 'a', 'd') >::RESULT,
                       m_roadID);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL4('l', 'a', 'n', 'e') >::RESULT,
                       m_laneID);

                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('p', 'o', 'i', 'n', 't') >::RESULT,
                       m_pointID);

    ...
    namespace data {
        namespace scenario {
            ...
            ostream& Road::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL8('n', 'u', 'm', 'l', 'a', 'n', 'e', 's') >::RESULT,
                        numberOfLanes);
                ...
                // Write lanes.
                if (numberOfLanes > 0) {
                    s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL5('l', 'a', 'n', 'e', 's') >::RESULT,
                            sstr.str());
                }
            ...
            istream& Road::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL8('n', 'u', 'm', 'l', 'a', 'n', 'e', 's') >::RESULT,
                       numberOfLanes);

                if (numberOfLanes > 0) {
                    string str;
                    // Read lanes into stringstream.
                    d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL5('l', 'a', 'n', 'e', 's') >::RESULT,
                           str);

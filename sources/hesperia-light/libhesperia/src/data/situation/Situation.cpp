    ...
    namespace data {
        namespace situation {
            ...
            ostream& Situation::operator<<(ostream &out) const {
                ...
                s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL6('n', 'u', 'm', 'o', 'b', 's') >::RESULT,
                        numberOfObjects);
                ...
                if (numberOfObjects > 0) {
                    s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL7('o', 'b', 'j', 'e', 'c', 't', 's') >::RESULT,
                            sstr.str());
                }
            ...
            istream& Situation::operator>>(istream &in) {
                ...
                d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL6('n', 'u', 'm', 'o', 'b', 's') >::RESULT,
                       numberOfObjects);

                if (numberOfObjects > 0) {
                    string str;
                    // Read layers into stringstream.
                    d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL7('o', 'b', 'j', 'e', 'c', 't', 's') >::RESULT,
                           str);

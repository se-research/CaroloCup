...
namespace hesperia {
    namespace decorator {
        namespace twoD {
            ...
            void Renderer2D::drawListOfTriangleSets(const vector<hesperia::decorator::models::TriangleSet> &listOfTriangleSets, const data::environment::Point3 &position, const data::environment::Point3 &rotation) {

...
namespace hesperia {
    namespace dmcp {
        ...
        ostream& ServerInformation::operator<<(ostream &out) const
        {
            ...
            s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL2('i', 'p') >::RESULT, m_serverIP);
            s.write(CRC32 < HESPERIA_CORE_STRINGLITERAL4('p', 'o', 'r', 't') >::RESULT, m_serverPort);
        ...
        istream& ServerInformation::operator>>(istream &in)
        {
            ...
            d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL2('i', 'p') >::RESULT, m_serverIP);
            d.read(CRC32 < HESPERIA_CORE_STRINGLITERAL4('p', 'o', 'r', 't') >::RESULT, m_serverPort);

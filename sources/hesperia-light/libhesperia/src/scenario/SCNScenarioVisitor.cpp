    ...
    namespace scenario {
        ...
        const IDVertex3 SCNScenarioVisitor::visitIDVertex3(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from ID expected.");
                }
        ...
        const Vertex3 SCNScenarioVisitor::visitVertex3(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from X expected.");
                }
                v.setX(n->getValue<double>());

                n = node->getNodeFromFirstMatchingChildFor("Y");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from Y expected.");
                }
        ...
        ComplexModel* SCNScenarioVisitor::visitComplexModel(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get name from MODELFILE expected.");
                }
                cm->setModelFile(n->getValue<string>());

                n = *(node->getChildren("POSITION").begin() + 1); // Skip keyword "POSITION".
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get name from POSITION expected.");
                }
                cm->setPosition(visitVertex3(n));

                n = *(node->getChildren("ROTATION").begin() + 1); // Skip keyword "ROTATION".
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get name from ROTATION expected.");
                }
                ...
                if (boundingBox.size() != 5) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get name from BOUNDINGBOX expected.");
                }
        ...
        Polygon* SCNScenarioVisitor::visitPolygon(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get name from HEIGHT expected.");
                }
                p->setHeight(n->getValue<double>());

                n = *(node->getChildren("COLOR").begin() + 1); // Skip keyword "COLOR".
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get name from COLOR expected.");
                }
        ...
        Cylinder* SCNScenarioVisitor::visitCylinder(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get name from VERTEX2 expected.");
                }
                c = new Cylinder();
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get name from RADIUS expected.");
                }
        ...
        Shape* SCNScenarioVisitor::visitShape(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                n = node->getFirstChild();
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get name from SHAPE expected.");
                }
                string name = n->getValue<string>();

                n = (node->getChildren().at(1))->getFirstChild();
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from SHAPE expected.");
                }
        ...
        const HeightImage SCNScenarioVisitor::visitHeightImage(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from HEIGHTIMAGE expected.");
                }
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from GROUNDHEIGHT expected.");
                }
                hi.setGroundHeight(n->getValue<double>());

                n = node->getNodeFromFirstMatchingChildFor("MINHEIGHT");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from MINHEIGHT expected.");
                }
                hi.setMinimumHeight(n->getValue<double>());

                n = node->getNodeFromFirstMatchingChildFor("MAXHEIGHT");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from MAXHEIGHT expected.");
                }
        ...
        const Image SCNScenarioVisitor::visitImage(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from IMAGE expected.");
                }
                i.setFileName(n->getValue<string>());

                n = node->getNodeFromFirstMatchingChildFor("ORIGINX");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from ORIGINX expected.");
                }
                i.setOriginX(n->getValue<uint32_t>());

                n = node->getNodeFromFirstMatchingChildFor("ORIGINY");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from ORIGINY expected.");
                }
                i.setOriginY(n->getValue<uint32_t>());

                n = node->getNodeFromFirstMatchingChildFor("MPPX");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from MPPX expected.");
                }
                i.setMeterPerPixelX(n->getValue<double>());

                n = node->getNodeFromFirstMatchingChildFor("MPPY");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from MPPY expected.");
                }
                i.setMeterPerPixelY(n->getValue<double>());

                n = node->getNodeFromFirstMatchingChildFor("ROTZ");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from ROTZ expected.");
                }
        ...
        const Ground SCNScenarioVisitor::visitGround(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from GROUND expected.");
                }
        ...
        const WGS84CoordinateSystem SCNScenarioVisitor::visitCoordinateSystem(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from ROTATION expected.");
                }
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from ORIGIN expected.");
                }
        ...
        const Header SCNScenarioVisitor::visitScenarioHeader(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from SCENARIO expected.");
                }
                header.setName(n->getValue<string>());

                n = node->getNodeFromFirstMatchingChildFor("VERSION");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from VERSION expected.");
                }
                header.setVersion(n->getValue<string>());

                n = node->getNodeFromFirstMatchingChildFor("DATE");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from DATE expected.");
                }
                header.setDate(n->getValue<string>());

                n = *(node->getChildren("ORIGINCOORDINATESYSTEM").begin() + 1); // Skip keyword "ORIGINCOORDINATESYSTEM".
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from ORIGINCOORDINATESYSTEM expected.");
                }
        ...
        Connector SCNScenarioVisitor::visitConnector(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from CONNECTOR expected.");
                }
        ...
        Arc* SCNScenarioVisitor::visitArc(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                n = node->getNodeFromFirstMatchingChildFor("RADIUS");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from RADIUS expected.");
                }
                a = new Arc();
                ...
                if (list.size() != 2) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from interval expected.");
                }
        ...
        Clothoid* SCNScenarioVisitor::visitClothoid(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from DK expected.");
                }
                c->setDK(n->getValue<double>());

                n = node->getNodeFromFirstMatchingChildFor("K");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from K expected.");
                }
        ...
        TrafficSign* SCNScenarioVisitor::visitTrafficSign(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from VALUE expected.");
                }
                ts = new TrafficSign();
        ...
        Lane SCNScenarioVisitor::visitLane(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from LANEID expected.");
                }
        ...
        Road SCNScenarioVisitor::visitRoad(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from ROADID expected.");
                }
                r.setID(n->getValue<uint32_t>());

                n = node->getNodeFromFirstMatchingChildFor("ROADNAME");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from ROADNAME expected.");
                }
        ...
        Spot SCNScenarioVisitor::visitSpot(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from SPOTID expected.");
                }
                s.setID(n->getValue<uint32_t>());

                n = node->getChildren("SPOTID").at(1);
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value for first vertex expected.");
                }
                s.setFirstVertex(visitVertex3(n));

                n = node->getChildren("SPOTID").at(2);
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value for second vertex expected.");
                }
        ...
        Zone SCNScenarioVisitor::visitZone(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from ZONEID expected.");
                }
                z.setID(n->getValue<uint32_t>());

                n = node->getNodeFromFirstMatchingChildFor("ZONENAME");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from ZONENAME expected.");
                }
        ...
        Layer SCNScenarioVisitor::visitLayer(ASTNode *node) {
            ...
            if (node != NULL) {
                ...
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from LAYER expected.");
                }
                l.setName(n->getValue<string>());

                n = node->getNodeFromFirstMatchingChildFor("LAYERID");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from LAYERID expected.");
                }
                l.setID(n->getValue<uint32_t>());

                n = node->getNodeFromFirstMatchingChildFor("HEIGHT");
                if (n == NULL) {
                    HESPERIA_CORE_THROW_EXCEPTION(SCNScenarioVisitorException, "Node to get value from HEIGHT expected.");
                }
